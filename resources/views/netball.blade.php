                ...
                <div class="w-full mx-5  py-8 my-4 px-2 shadow-xl rounded-xl flex justify-center bg-gray-200">
                    <form class="space-y-4" action="{{ route('netball.store') }}" method="POST">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <select id="standnumber" name="standnumber" class="flex-1 rounded-lg border px-3 py-2"required>
                            <option value="" disabled selected>Select Seat Number</option> <!-- Add this line -->
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const seatNumberSelect = document.getElementById('standnumber');

        // Generate seat numbers dynamically up to 2000
